...
exports.exampleLoadSettings = exampleLoadSettings;
exports.exampleSaveSettings = exampleSaveSettings;
exports.exampleSaveMetrics = exampleSaveMetrics;
exports.exampleGetMetricsForGraph = exampleGetMetricsForGraph;
exports.exampleGetMetricsByTimeRange = exampleGetMetricsByTimeRange;
exports.exampleCreateIncident = exampleCreateIncident;
exports.exampleResolveIncident = exampleResolveIncident;
exports.exampleGetOngoingIncidents = exampleGetOngoingIncidents;
exports.exampleGetServiceIncidentHistory = exampleGetServiceIncidentHistory;
exports.exampleCreateCPUAlert = exampleCreateCPUAlert;
exports.exampleCreateSystemAlerts = exampleCreateSystemAlerts;
exports.exampleCheckAlerts = exampleCheckAlerts;
exports.exampleToggleAlert = exampleToggleAlert;
exports.exampleUpdateAlertThreshold = exampleUpdateAlertThreshold;
exports.exampleDeleteOldAlerts = exampleDeleteOldAlerts;
exports.exampleMonitoringWorkflow = exampleMonitoringWorkflow;
exports.exampleDashboardInit = exampleDashboardInit;
...
async function exampleLoadSettings() {
    const settings = await (0, appwrite_service_1.getSettings)();
    if (settings) {
 ...
 */
async function exampleSaveSettings(settings) {
    const success = await (0, appwrite_service_1.saveSettings)(settings);
    if (success) {
 ...
 */
async function exampleSaveMetrics(currentMetrics) {
    await (0, appwrite_service_1.saveMetricsSnapshot)({
...
async function exampleGetMetricsForGraph() {
    ...
    const dayMetrics = await (0, appwrite_service_1.getMetricsHistory)('day');
    // Transform for chart
...
async function exampleGetMetricsByTimeRange() {
    const hourMetrics = await (0, appwrite_service_1.getMetricsHistory)('hour'); // Last hour
    const dayMetrics = await (0, appwrite_service_1.getMetricsHistory)('day'); // Last 24 hours
    const weekMetrics = await (0, appwrite_service_1.getMetricsHistory)('week'); // Last 7 days
    const monthMetrics = await (0, appwrite_service_1.getMetricsHistory)('month'); // Last 30 days
 ...
 */
async function exampleCreateIncident(serviceId, serviceName) {
    await (0, appwrite_service_1.createIncident)({
        serviceId,
        serviceName,
 ...
 */
async function exampleResolveIncident(incidentId) {
    const success = await (0, appwrite_service_1.resolveIncident)(incidentId);
    if (success) {
...
async function exampleGetOngoingIncidents() {
    const incidents = await (0, appwrite_service_1.getIncidents)('ongoing');
    // Display in UI
 ...
 */
async function exampleGetServiceIncidentHistory(serviceId) {
    const allIncidents = await (0, appwrite_service_1.getIncidents)();
    // Filter by service
...
async function exampleCreateCPUAlert() {
    await (0, appwrite_service_1.saveAlert)({
        type: 'cpu',
        threshold: 80,
        enabled: true,
...
async function exampleCreateSystemAlerts() {
    const alerts = [
        { type: 'cpu', threshold: 80, description: 'High CPU usage' },
        { type: 'memory', threshold: 85, description: 'High memory usage' },
        { type: 'disk', threshold: 90, description: 'Low disk space' },
    ];
 ...
 */
async function exampleCheckAlerts(currentMetrics) {
    const enabledAlerts = await (0, appwrite_service_1.getAlerts)(true);
    for (const alert of enabledAlerts) {
        ...
        if (currentValue >= alert.threshold && alert.$id) {
            // Alert triggered!
            await (0, appwrite_service_1.updateAlert)(alert.$id, {
 ...
 */
async function exampleToggleAlert(alertId, enabled) {
    await (0, appwrite_service_1.updateAlert)(alertId, { enabled });
}
/**
 * Example: Update alert threshold
 */
async function exampleUpdateAlertThreshold(alertId, newThreshold) {
    await (0, appwrite_service_1.updateAlert)(alertId, { threshold: newThreshold });
}
/**
 * Example: Delete old alerts
 */
async function exampleDeleteOldAlerts() {
    const allAlerts = await (0, appwrite_service_1.getAlerts)();
    ...
    for (const alert of allAlerts) {
        ...
        if (createdAt < thirtyDaysAgo && alert.$id) {
            await (0, appwrite_service_1.deleteAlert)(alert.$id);
    ...
    for (const service of services.services) {
        if (service.status === 'offline') {
            ...
            if (serviceIncident && serviceIncident.$id) {
                await (0, appwrite_service_1.resolveIncident)(serviceIncident.$id);
            }
        }
    }
}
...
async function exampleDashboardInit() {
    ...
    const recentIncidents = await (0, appwrite_service_1.getIncidents)(undefined, 10);
    // Get metrics for the last hour
    const metricsHistory = await (0, appwrite_service_1.getMetricsHistory)('hour');
    // Get active alerts
    const activeAlerts = await (0, appwrite_service_1.getAlerts)(true);
    return {
        settings,
        recentIncidents,
        metricsHistory,
